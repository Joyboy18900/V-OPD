<footer class="probootstrap-footer">
    <div class="container">
        <!-- <div class="row mb-5">
            <div class="col-md-3">
                ...
                <ul class="list-unstyled probootstrap-footer-recent-post">
                    <li>
                        <a href="#"><span class="date">November 15, 2017</span> The practice of medicine is a lot like
                            parenting
                        </a>
                    </li>
                    <li>
                        <a href="#"><span class="date">November 15, 2017</span>Physicians: Want to overcome burnout?
                            Start
                            studying business. </a>
                    </li>
                </ul>
        ...
        <div class="row probootstrap-copyright">
            <div class="col-md-12">
                <p><small>&copy; <?php echo date('Y'); ?> Chanatu Studio. All Rights
                        Reserved.
                    </small></p>
            </div>
        </div>
