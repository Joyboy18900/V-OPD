      ...
      *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="text-section-heading-1"><i class="fa fa-user"></i> ปกติ
                    <small></small>
                </div>
                        ...
                        <div class="form-panel col-md-12">
                            ...
                            <form class="style-form" id="frm_add">
                                <div class="form-group col-md-6">
                                    <label class="col-sm-12 col-sm-12 control-label">ค้นหา</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group col-md-6 hidden">
                                    <label class="col-sm-12 col-sm-12 control-label">รหัสผู้ใช้</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">ชื่อ - นามสกุล</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="p_fullname" readonly>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">วัน/เดือน/ปีเกิด</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">กรุ๊ปเลือด</label>
                                    <div class="col-md-12">
                                ...
                                <div class="clearfix"></div>
                                <!-- <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">แผนกงานของผู้ใช้</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="dep_name" readonly>
                                    </div>
                                </div> -->
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">โรคประจำตัว</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="op_cd">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">อาหารที่แพ้</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="op_food_allergy">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">แพ้ที่ยา</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="op_drugs_allergy">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">น้ำหนัก</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="op_weight">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">ส่วนสูง</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="op_height">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">อุณหภูมิ</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="op_body_temp">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">ความดันโลหิต</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="op_bp">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">แผนก</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">เลือกแพทย์</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="col-sm-12 col-sm-12 control-label">รายละเอียดอาการป่วย</label>
                                    <div class="col-md-12">
                            ...
                            success: function (data) {
                                ...
                                if (data.errorStatus) {
                                    ...
                                    window.location.href =
                                        "contactBooking.php?room_id=" + room_id +
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data) {
                            ...
                            $("#p_fullname").val(data[0].prefix_name + data[0].p_name +
                                ' ' + data[
                                    0].p_lname);
