    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 mb-4">
          <a href="index.html" class="mr-auto"><img src="assets/images/logo.png" width="212" height="48" class="hires" alt="Free Template by ProBootstrap"></a>
        </div>
        <div class="col-md-9">
  ...
  <footer class="probootstrap-footer">
    <div class="container">
      ...
      <div class="row probootstrap-copyright">
        <div class="col-md-12">
          <p><small>&copy; 2017 <a href="https://uicookies.com/" target="_blank">ProBootstrap Health</a>. All Rights
